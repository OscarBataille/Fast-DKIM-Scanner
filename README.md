# High performance DKIM key bruteforcer
...
2. It uses massdns for retrieving the records from the DNS servers.
...
```python3 generate_dkim_selectors.py <domain> > output```
